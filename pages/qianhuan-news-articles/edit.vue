<template>
  <view class="uni-container">
    <uni-forms ref="form" :model="formData" validate-trigger="submit" err-show-type="toast">
      ...
      <uni-forms-item name="dispalytext" label="文章摘要">
        <uni-easyinput placeholder="文章摘要" v-model="formData.dispalytext" trim="both"></uni-easyinput>
      </uni-forms-item>
...
<script>
  import { validator } from '../../js_sdk/validator/qianhuan-news-articles.js';

  const db = uniCloud.database();
  const dbCollectionName = 'qianhuan-news-articles';
  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("user_id,title,dispalytext,province,content,article_status,view_count,like_count,is_sticky,comment_count,last_comment_user_id,picurls,publish_date,publish_ip,last_modify_date,last_modify_ip").get().then((res) => {
